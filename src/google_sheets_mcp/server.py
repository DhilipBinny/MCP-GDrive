...
def gsheets_read(
    ...
    """Read data from a spreadsheet — cell values, metadata, search, or list conditional formats.
    ...
    Args:
        ...
        action: Operation — "read", "info", "find", or "list_conditional_formats"
    ...
    if a == "read":
        ...
        return f"ERROR: Unknown action '{action}'. Use: read, info, find, list_conditional_formats"
